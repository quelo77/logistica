...
Bootstrap.elementOrParentIsFixed = function(element) {
    var $element = $(element);
...
;(function($) {
    ...
    _generateID = function() {
      _lastID++;
      return 'bootstrap-lean-overlay-' + _lastID;
    };
...
;bootstrap.toast = function (message, displayLength, className, completeCallback) {
    className = className || "";
...
//          offset - 200 allows elements near bottom of page to scroll
  ...
  $(document).ready(function() {
    ...
    bootstrap.updateTextFields = function() {
    ...
    var text_area_selector = '.bootstrap-textarea';
...
;(function ($) {
  ...
  bootstrap.fadeInImage =  function(selector){
  ...
  bootstrap.showStaggeredList = function(selector) {
    var time = 0;
...
;(function($) {
  ...
  bootstrap.scrollFire = function(options) {
